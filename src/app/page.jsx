  ...
  return (
    <main className="min-h-screen "> 
      <article className="flex flex-col items-center justify-between ">
        ...
        <section className="max-w-screen-lg flex flex-row items-center justify-center lg:mb-40">
          <div>
      ...
      <section className="mx-1.5 md:mx-0 lg:mx-28 ">
        <div className="overflow-x-auto whitespace-no-wrap px-3 md:px-8 lg:px-16 py-16 grid grid-flow-col w-full items-center">
        
          <div className="bg-blue-900 rounded-lg mt-24 md:mt-32 lg:mt-32 w-[400px] md:w-auto">
            <ul className="text-white leading-7 lg:leading-9 p-2 md:p-4 lg:p-8 ">
          ...
          <div className=" text-center bg-slate-100 rounded-lg shadow-lg text-blue-800 pt-5 md:pt-10 w-[200px] md:w-auto">
          ...
          <div className="text-center bg-blue-400 rounded-lg shadow-lg py-5 text-white pt-5 md:pt-10 w-[200px] md:w-auto">
            <h1 className="md:text-2xl font-bold">CHAMPION</h1>
              <p className="pb-5">$1299/ Month</p>
              <button className="border border-blue-800 rounded-lg p-1 md:py-1 md:px-4 text-xs font-secular ">Order Now</button>
              <ul className="leading-7 lg:leading-9 py-8">
                <li><a href="">L1, L2 & L3</a></li>
                <li><a href="">Yes</a></li>
      ...
      <article className="flex flex-col items-center justify-between">
        <section className="max-w-screen-sm mb-20 text-blue-800 font-medium my-4 lg:mx-40">
          <div className="flex justify-center items-center">
